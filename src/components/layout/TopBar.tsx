  ...
  return (
    <div className="h-12 bg-[var(--bg-panel)] border-b border-[var(--border)] flex items-center justify-between px-4 z-50">
      ...
      <div className="flex items-center gap-3">
        <a
          href="https://github.com/khuza08/chromagrade"
          target="_blank"
          rel="noopener noreferrer"
          className="p-1.5 hover:bg-[var(--bg-hover)] rounded text-[var(--text-secondary)] hover:text-[var(--text-primary)] transition-colors"
